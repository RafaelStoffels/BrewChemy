...
def _apply_updates(item: Equipment, data: EquipmentUpdate) -> None:
    if data.name is not None: item.name = data.name
    if data.description is not None: item.description = data.description
    if data.efficiency is not None: item.efficiency = data.efficiency
    if data.batchVolume is not None: item.batch_volume = data.batchVolume
    if data.batchTime is not None: item.batch_time = data.batchTime
    if data.boilTime is not None: item.boil_time = data.boilTime
    if data.boilTemperature is not None: item.boil_temperature = data.boilTemperature
    if data.boilOff is not None: item.boil_off = data.boilOff
    if data.trubLoss is not None: item.trub_loss = data.trubLoss
    if data.deadSpace is not None: item.dead_space = data.deadSpace
